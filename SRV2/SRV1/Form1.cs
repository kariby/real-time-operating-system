...
namespace SRV1
{
    public partial class Form1 : Form
    {
        ...
        public Form1()
        {
            ...
            nWorkerThreads = 10;
            nCompletionThreads = 1;
            label2.Text += ", " + nWorkerThreads + " threads";
        ...
        void tr2(object state)
        {
            while (work)
            {
                ...
                mutex.ReleaseMutex();
                string str = "Thread " + nCompletionThreads + " work with " + num;
                nCompletionThreads = nCompletionThreads + 1;
        ...
        private void btnStart_Click(object sender, EventArgs e)
        {
            ...
            for (int i = 1; i < nWorkerThreads; i++)
